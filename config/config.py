...
parser.add_argument('--storing_channels', type=int, default=32, help='the number of channels to store')
...
parser.add_argument('--decay_epoch', type=int, default=200, help='decayed batch size')
...
parser.add_argument('--penalty_loss_factor', type=float, default=0.1)
parser.add_argument('--discriminator_loss_factor', type=float, default=0.01)
parser.add_argument('--rate_loss_factor', type=float, default=0.0001)
...
parser.add_argument('--num_epoch', type=int, default=500, help='end epoch')
